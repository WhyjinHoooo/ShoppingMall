...
public class ProductController extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equals("/addProduct.do")) {
			File currentDirPath = new File("C:\\Users\\yach3\\eclipse-workspace\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\web01\\img"); 
			...
			dispatch.forward(request, response);//?
			if (nextPage != null) {
				RequestDispatcher dispatch1 = request.getRequestDispatcher(nextPage);
